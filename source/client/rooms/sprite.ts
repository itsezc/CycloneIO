        ...
        do
        {
            ...
            if (tileData != "x")
            {
                ...
                floorSprite.on('pointerdown', () =>
                {
                    ...
                    var cartAvatarCoords = this.scene.isometricToCartesian({ x: this.scene.avatar.x, y: this.scene.avatar.y + 84, z: 0 })
                    ...
                    var path = this.scene.finder.findPath(avatarCoords.x, avatarCoords.y, tileCoords.x, tileCoords.y, this.scene.grid)
                    ...
                    for (var i = 1;i < path.length;i++)
                    {
                        ...
                        this.scene.physics.moveTo(this.scene.avatar, tileX, tileY - 84)
