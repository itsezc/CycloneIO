    ...
    render(){
        return (
            <section className="room">
                ...
                <div className="dialog-body" style={{display: 'none', background: 'blue', padding: 32, resize: 'vertical', overflow: 'auto', width: 500, height: 700, position: 'absolute', top: 90, left: 60 }}>
                    <ScrollBar >
