...
export default class MainEngine {
    ...
    onMouseDownHandler: (mouseX: number, mouseY: number, altKey: boolean) => void;
    ...
    constructor(gameLoop: Function, onResize: () => void,
        ...
        onMouseDown: (mouseX: number, mouseY: number, altKey: boolean) => void,
        ...
        logicApp.renderer.plugins.accessibility.destroy();
        //logicApp.renderer.plugins.extract.destroy();
        logicApp.renderer.plugins.interaction.destroy();
        logicApp.renderer.plugins.prepare.destroy();

        app.ticker.add(delta => gameLoop(delta));
        app.ticker.minFPS = 0;
        logicApp.ticker.maxFPS = 1;
    ...
    setMouseInteractions = () => {
        ...
        this.pixiApp.view.addEventListener('mousedown', (evt) => {
            this.onMouseDownHandler(evt.x, evt.y, evt.altKey);
        }, false);
