...
export default class Chat extends React.Component<ChatProps, ChatState> {
    chatWrapper: React.RefObject<HTMLDivElement>;
    ...
    generateLeftArrow(): React.ReactNode {
        const { currentTabOffset } = this.state;
    ...
    generateRightArrow(): React.ReactNode {
    ...
    generateMainTabs(): React.ReactNode {
        const { activeChats, currentTabOffset } = this.state;
